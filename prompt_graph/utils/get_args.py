...
def get_args():
    ...
    parser.add_argument('--lambda_', type=float, default = 0.0, help='')
    parser.add_argument('--pretrain_lr', type=float, default = 0.01, help='')
    parser.add_argument('--pretrain_decay', type=float, default = 0.0001, help='')
    parser.add_argument('--pretrain_patience', type=int, default = 10, help='')
